...
myPersevereCodeObj.currrentScore = 3
...
myPersevereCodeObj.cumulativeScore = myPersevereCodeObj.currrentScore + myPersevereCodeObj.cumulativeScore
// or myPersevereCodeObj.cumulativeScore += myPersevereCodeObj.currrentScore
...
person.address.push("5555", "Mytown", "Memphis")
...
const car = {
  ...
  year: 2018,
  isRunning: true,
  accessories: ["mud tires", "fuzzy dice", "8 track player", "running boards"],  "4 x 4": false
}
